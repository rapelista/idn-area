...
exports.BaseValidationPipe = void 0;
...
let BaseValidationPipe = class BaseValidationPipe {
    ...
    formatErrors(errors) {
        return errors.map((err) => {
            ...
            const baseErrorFormat = new base_response_1.BaseExceptionResponse(code, detail, err.property);
            return baseErrorFormat;
        });
    }
};
exports.BaseValidationPipe = BaseValidationPipe;
exports.BaseValidationPipe = BaseValidationPipe = __decorate([
    (0, common_1.Injectable)()
], BaseValidationPipe);
//# sourceMappingURL=base-validation.pipes.js.map