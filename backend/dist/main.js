...
const seeders_service_1 = require("./database/seeders/seeders.service");
async function bootstrap() {
    const app = await core_1.NestFactory.create(app_module_1.AppModule);
    app.useGlobalPipes(new common_1.ValidationPipe({
        transform: true,
    }));
    const seedService = app.get(seeders_service_1.SeedersService);
    ...
    const config = new swagger_1.DocumentBuilder()
        ...
        .setDescription('IDN-Area API adalah layanan yang digunakan untuk mengelola data wilayah administratif di Indonesia. ' +
    ...
    swagger_1.SwaggerModule.setup('iqro', app, document, {
